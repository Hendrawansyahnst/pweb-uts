...
<template>
  ...
  <div class="x text-center">
    ...
    <br />
    <img src="../assets/alquran.png" alt="logo" width="400px" />
    <br />
    <br />
  ...
  <div id="1">
    <div class="text-center">
      <h1 class="p">Ketikkan nomor surat yang ingin dicari!</h1>
    </div>
    <div class="search">
      <input
          v-model="cari"
          ...
          type="search"
          placeholder="Cari Surah (contoh: 80)"
          aria-label="Search"
      />
    </div>
...
.pa {
  font-family: Roboto;
  background: linear-gradient(50deg, #025f06, #04dd28);
  animation: hue-rotate 3s linear infinite alternate;
  border-color: rgb(5, 99, 5);
  width: 200px;
  margin-top: 30px;
}
