...
<template>
  ...
  <section id="about">
    <div class="mt-5">
      ...
      <h1>About Us</h1>
      <p>
        Al-Quran was founded in 2023. The website aims to make it easy for anyone to read, study, and learn the Quran.
      </p>
    </center>
    </div>
    <div class="my-5">
          ...
          <div class="card-body text-start">
            <table class="table">
              ...
              <tr>
                <td>Name</td>
                <td>:</td>
                <td>Hendrawansyah Nasution</td>
              </tr>
              <tr>
                <td>University</td>
                <td>:</td>
                <td>UIN Sultan Syarif Kasim Riau</td>
              </tr>
              <tr>
